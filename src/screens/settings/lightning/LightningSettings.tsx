...
import { lspNodeDev, selectedNetwork } from "../../../util/config";
...
export const LightningSettings = observer(() => {
  ...
  const addPeer = lspNodeDev[selectedNetwork]
  return (
    <BaseComponent>
      ...
      <TouchableOpacity style={styles.lightningSettings} onPress={async () => {
        const peer = await lightningStore.addPeer(addPeer.address, addPeer.port, addPeer.pubKey)
