...
type HomeFeedProps = NativeStackNavigationProp<
  NostrParamList,
  'nostr-home-feed'
>;
    ...
    <BaseComponent>
      <TopNavigation
        ...
        accessoryLeft={() => (
          <Pressable
            onPress={() =>
              navigation.navigate('nostr-profile', {pubkey: nostrKeys.pubkey})
            }>
      ...
      <ScrollView>
        <Layout style={{marginHorizontal: 10}}>
          {feed &&
            profiles &&
            feed.map(event => {
              let profile: Metadata = profiles?.find(
              ...
              if (!profile || profile === undefined) {
                profile = {
                  pubkey: event.pubkey,
                  name: 'Unknown',
                  picture: 'https://i.imgur.com/2xW3b2F.png',
                };
              }
              return (
                <Note
